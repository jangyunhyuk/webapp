    ...
    <script>
	 // 로그인 화면을 표시하는 함수
	    ...
	    function logout() {
	        ...
	        form.method = 'POST';
	        form.action = 'logout';  // 로그아웃 처리하는 서버의 URL
	
	        document.body.appendChild(form);  // 폼을 동적으로 생성
	        form.submit();  // 폼을 제출하여 로그아웃
	    }
		...
		<div id="auth-section">
			...
			<c:if test="${not empty sessionScope.user}">
				<div id="user-info"
					...
					<span id="username"
						title="${sessionScope.user.roles[0]}
